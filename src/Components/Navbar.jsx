...
const Navbar = () => {
    ...
    const linkClass = "block py-1 px-2 rounded-sm hover:bg-gray-200"

    const activeLink = ({ isActive }) => {
        return `${linkClass} ${isActive ? 'bg-[#f39c12] font-semibold' : 'text-gray-700'}`
    }
    ...
    return (
        <>
            ...
            <Container>
                ...
                <div className="navbar  z-100 pt-0 ">
                    <div className="navbar-start">
                        <div className="dropdown  ">
                            ...
                            <ul
                                tabIndex="-1"
                                className=" dropdown-content border rounded-box z-100 mt-3 w-52 p-2 shadow ">
                                {links}
                            </ul>
                        </div>
                                ...
                                <div className="dropdown dropdown-end">
                                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                                        <div className=" rounded-full">
                                            <FaUserCircle color='#f39c12' size={36} />
